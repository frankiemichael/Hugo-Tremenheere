                ...
                e.stopImmediatePropagation();
                  ...
                  $.ajax({
                    ...
                    success: function(result){
                      ...
                      $('#soldproducts').append("<div id='solditems'><div>" + JSON.stringify(productlist.customFields[0].value) + "</div><div>" + JSON.stringify(productlist.name) + "</div><div class='qtydiv'><button type='button' id='plus' class='qtybutton' style='display:none;'>+</button><input type='text' name='qty' id='qty' value='" + JSON.stringify(productlist.quantity) + "'readonly></input><button type='button' id='minus' class='qtybutton' style='display:none;'>-</button></div><div>£" + JSON.stringify(productlist.price) + "</div><div>£" + JSON.stringify(productlist.totalPrice) + "</div></div>")
