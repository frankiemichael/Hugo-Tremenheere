...
$("#executeButton").click (function(e) {
  ...
  var host = 'https://app.snipcart.com/api/products' + "?offset=" + offset + "&limit=" + limit + "&userDefinedId=" + productid
  var puthost = 'https://app.snipcart.com/api/products/'
    ...
    $.ajax({
        ...
        success: function(result){
            ...
            $.each(obj, function(i, val){
              ...
              var final = obj[i];
              console.log(final);
              $('#apidata').append("<div id='productid'><button type='button' id='buttonclick' name='button2'><span id='buttonspan'>" + JSON.stringify(final.userDefinedId) + "</span></button><br><span>" + JSON.stringify(date) + "</div>" )
              $('#apidata').append("<div id='apiname'> <h4>" + JSON.stringify(string.name) + "</h4> </div>" )
              $('#apidata').append("<div id='apisku'> <h4>" + JSON.stringify(string.customFields[0].value) + "</h4> </div>" )
              $('#apidata').append("<div id='apiprice'> <h4>" + JSON.stringify(string.stock) + "</h4> </div>" )
              $('#apidata').append("<div id='apisku'> <h4>£" + JSON.stringify(string.price) + "</h4> </div>" )
